...
nspanel_ha_ns = cg.esphome_ns.namespace('nspanel_ha')
...
async def to_code(config):
    ...
    if CORE.using_arduino:
        _LOGGER.warning("Arduino framework deprecated in v4.3.22. Migrate to ESP-IDF: https://github.com/otghcloud/nspanel-ha/blob/main/docs/customization.md#frameworks")
    ...
    cg.add_define("USE_NSPANEL_HA")
    cg.add_global(nspanel_ha_ns.using)
