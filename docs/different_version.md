...
For available versions and branches, visit: [NSPanel_HA_Blueprint Tags](https://github.com/otghcloud/nspanel-ha/tags).
...
> [!NOTE]
> When using `dev` or `beta`, report findings in the [issues](https://github.com/otghcloud/nspanel-ha/issues) section, clearly stating the version.
>
...
1. On the GitHub repository, click on your chosen version name on the [NSPanel_HA_Blueprint Tags](https://github.com/otghcloud/nspanel-ha/tags) list, then select the tab **Code**.
...
1. Use your preferred code editor to edit the blueprint file under `/homeassistant/blueprints/automation/Blackymas/nspanel_ha.yaml`.
2. Go to the GitHub repository and select the [branch (`main`, `beta` or `dev`)](https://github.com/otghcloud/nspanel-ha/branches)
or the [tag](https://github.com/otghcloud/nspanel-ha/tags) (for previous versions) you want to use.
3. Find the file `nspanel_ha.yaml` in the root of the branch/tag, then click on it to open the file content visualization.
...
and check the [issues](https://github.com/otghcloud/nspanel-ha/issues)
and [discussions](https://github.com/otghcloud/nspanel-ha/discussions) sections on our GitHub repository.
