...
> You can create an issue reporting this, or fix it yourself and submit a [Pull Request](https://github.com/otghcloud/nspanel-ha/pulls) to this repository.
...
8. Clear all existing content and paste the following YAML configuration:
   ...
   packages:
     remote_package:
       url: https://github.com/otghcloud/nspanel-ha
       ref: main
       refresh: 300s
       files:
...
![114730547 MP](https://github.com/otghcloud/nspanel-ha/assets/5879533/575bc3de-a2ae-4440-a420-751325e55122)
...
3. **Choose the Installation Method:**
   ...
   ![140043](https://github.com/otghcloud/nspanel-ha/assets/5879533/3c08d3b7-df9b-4862-8ced-347deff41cb5)
...
4. **Transfer Firmware via USB-to-Serial TTL:**
   ...
   - Click **Connect** and choose the serial interface connected to your USB-to-Serial TTL adapter.
     ![141609](https://github.com/otghcloud/nspanel-ha/assets/5879533/fde27c26-3434-48f5-a028-6baee15ab35e)
   ...
   ![141248](https://github.com/otghcloud/nspanel-ha/assets/5879533/ad6a5813-131c-43d5-9174-3a9f73d5b6bf)
...
please [create a new issue](https://github.com/otghcloud/nspanel-ha/issues) and inform
...
[![Open your Home Assistant instance and show the blueprint import dialog with a specific blueprint pre-filled.](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fgithub.com%2FBlackymas%2FNSPanel_HA_Blueprint%2Fblob%2Fmain%2Fnspanel_ha.yaml)
...
Consider creating a [Pull Request](https://github.com/otghcloud/nspanel-ha/pulls) to the `dev` branch to share your discoveries with the community.
...
```log
[nspanel_ha] ESPHome:
[nspanel_ha]   Version:     2024.12.0
[nspanel_ha]   Free heap:
[nspanel_ha]     Internal:   45000 bytes (65.2%)
[nspanel_ha]     PSRAM:    3900000 bytes (95.1%)
```
...
The Blueprint file `nspanel_ha.yaml` can be customized for specific use cases.
...
1. Download `nspanel_ha.yaml` from the repository
...
If problems persist after troubleshooting, visit the [Issues](https://github.com/otghcloud/nspanel-ha/issues) page.
